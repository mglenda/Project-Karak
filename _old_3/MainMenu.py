...
from GUI.Buttons import Button,BUTTON_ARROWLEFT_GREEN,BUTTON_ARROWRIGHT_GREEN,BUTTON_CLASSIC_BLUE,BUTTON_CLASSIC_RED,BUTTON_CLASSIC_YELLOW
...
class PlayerWidget(G.Panel):
    ...
    def __init__(self, w=0, h=0,player: Player = None):
        ...
        self.hero_widget = HeroWidget(w=w*0.8,h=h*0.8)
        self.add(self.hero_widget)
        self.hero_widget.attach(self.hero_panel_background,G.ATTPOINT_CENTER,G.ATTPOINT_CENTER)
        ...
        self.player = player
        self.hero_widget.load_hero(player.get_hero())
...
class MainMenu(G.Panel):
    ...
    def __init__(self, w=0, h=0) -> None:
        ...
        self.play_button = Button(w=w,h=h,text='PLAY',button_style=BUTTON_CLASSIC_YELLOW,font_size=45)
        self.add(self.play_button,G.ATTPOINT_BOTTOMRIGHT,G.ATTPOINT_BOTTOMRIGHT,x_offset=-20,y_offset=-20)
    ...
    def random_hero(self):
        ...
        self.hero_widget.load_hero(self.hero)
        self.confirm_hero()
