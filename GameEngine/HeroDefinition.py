...
from GameEngine.Action import AstralWalking, Backstab, DoubleAttack, Stealth
...
class HeroDefinition():
    ...
    special_actions: list[type[Action]]
...
class Wizard(HeroDefinition):
    ...
    special_actions: list[type[Action]] = [AstralWalking]
...
class Thief(HeroDefinition):
    ...
    special_actions: list[type[Action]] = [Stealth, Backstab]
